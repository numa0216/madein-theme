...
<div class="<?php lightning_the_class_name( 'site-body' ); ?>">
	...
	<div class="<?php lightning_the_class_name( 'site-body-container' ); ?> container">
		...
		<div class="<?php lightning_the_class_name( 'main-section' ); ?>" id="main" role="main">
            ...
            <!-- ここから -->
            <div class="bubble"><a href="#"><img src="https://madein.works/wp-content/uploads/2023/06/注意のアイコン.svg" alt=""></a></div>
            <div class="icon"><a href="#"><img src="https://madein.works/wp-content/uploads/2023/06/家の無料アイコン.svg" alt=""></a></div>
            <div class="yaji"><img src="https://madein.works/wp-content/uploads/2023/06/矢印アイコン　下6.svg" alt=""></div>
            <!-- ここまで -->
